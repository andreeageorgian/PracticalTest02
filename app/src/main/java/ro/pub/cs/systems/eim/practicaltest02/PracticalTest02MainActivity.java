...
public class PracticalTest02MainActivity extends AppCompatActivity {
    ...
    private class GetInfoButtonClickListener implements Button.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            clientThread = new ClientThread(
                    clientAddress, Integer.parseInt(clientPort), word, length, showInfoTextView
            );
            clientThread.start();
        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lengthEditText = (EditText)findViewById(R.id.word_length_edit_text);
        getInfoButton = (Button)findViewById(R.id.get_info_btn);
        getInfoButton.setOnClickListener(getInfoButtonClickListener);
        showInfoTextView = (TextView)findViewById(R.id.result_text_view);
    }
